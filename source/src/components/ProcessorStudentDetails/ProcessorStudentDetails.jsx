...
//   const { id } = useParams(); // Getting student ID from URL params
...
//   if (loading) {
//     return <Container className="mt-4 text-center"><p>Loading student data...</p></Container>;
//   }
...
//               <Card className="mt-4">
//                 <Card.Body>
//                   <p className="text-center text-muted">Loading documents...</p>
//                 </Card.Body>
//               </Card>
