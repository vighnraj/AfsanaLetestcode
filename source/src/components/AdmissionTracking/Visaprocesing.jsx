...
const Visaprocesing = () => {
  ...
  const [userRole, setUserRole] = useState(null); // Added to track user role
              ...
              <Form.Group className="mb-3">
                ...
                {userRole === "student" ? (
                  <div className="alert alert-info">
                    ...
                    Payment proof can only be uploaded by admin staff.
                  </div>
                ) : (
                  <>
                    <Form.Control
            ...
            <Col md={12}>
              <Form.Group className="mb-3">
                ...
                {userRole === "student" ? (
                  <div className="alert alert-info">
                    <i className="bi bi-info-circle me-2"></i>
                    Interview recording can only be uploaded by admin staff.
                  </div>
                ) : (
                  <>
                    <Form.Control
                ...
                <div className="d-flex align-items-center">
                  <div className="flex-grow-1">
                    <div className="border rounded p-2 bg-light">
                      <div className="d-flex align-items-center">
                        <span className="me-2 text-muted">No file chosen</span>
                  ...
                  />
                  <label htmlFor="payment-proof-file-input" className="btn btn-outline-primary ms-2 mb-0">
