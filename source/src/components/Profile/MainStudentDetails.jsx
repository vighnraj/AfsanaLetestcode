                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-md-6">
                      ...
                      <input
                        ...
                        className="form-control form-control-sm"
                        value={form.passport_1_expiry ? new Date(form.passport_1_expiry).toISOString().split('T')[0] : ""}
                        onChange={handleChange}
                      />
                    </div>
                    <div className="col-md-6">
                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-md-6">
                      ...
                      <input
                        ...
                        className="form-control form-control-sm"
                        value={form.passport_2_expiry ? new Date(form.passport_2_expiry).toISOString().split('T')[0] : ""}
                        onChange={handleChange}
                      />
                    </div>
                    <div className="col-md-6">
                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-md-6">
                      ...
                      <input
                        ...
                        className="form-control form-control-sm"
                        value={form.passport_3_expiry ? new Date(form.passport_3_expiry).toISOString().split('T')[0] : ""}
                        onChange={handleChange}
                      />
                    </div>
                  </div>
