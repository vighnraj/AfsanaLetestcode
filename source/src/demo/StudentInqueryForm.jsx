...
import { Form, Row, Col, Modal, Button, InputGroup, Card } from "react-bootstrap";
import Swal from 'sweetalert2';
import BASE_URL from "../Config";
import api from "../services/axiosInterceptor";

const StudentInqueryForm = () => {
    ...
    <div className="container my-4">
      <Card className="shadow-sm p-4">
        <div className="text-center mb-4">
          <h2 className="fw-bold text-primary">Student Inquiry Form</h2>
          <p className="text-muted">Please fill out all the required information</p>
        </div>
        
        <Form onSubmit={handleAddInquiry}>
          {/* Inquiry Info */}
          <div className="bg-light p-3 rounded mb-4">
            <h4 className="mb-3">Inquiry Information</h4>
            <Row className="mb-3">
              <Col md={4}>
      ...
      <Form.Group controlId="phone">
        ...
        <InputGroup>
          ...
          {/* Course & Program Info */}
          <div className="bg-light p-3 rounded mb-4">
            <h4 className="mb-3">Course & Program Information</h4>
            <Row className="mb-3">
              <Col md={4}>
          ...
          {/* English Proficiency */}
          <div className="bg-light p-3 rounded mb-4">
            <h4 className="mb-3">English Proficiency</h4>
            <Row className="mb-3">
              <Col md={3}>
          ...
          {/* Work & Visa History */}
          <div className="bg-light p-3 rounded mb-4">
            <h4 className="mb-3">Work & Visa History</h4>
            <Row className="mb-3">
              <Col md={4}>
...
export default StudentInqueryForm;